    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                <span class="d-block d-lg-none">SARAN POKSOMBAT</span>
                <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="assets/img/rock.jpg" alt="..." /></span>
            </a>
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            ...
                            <p>ผมได้ฝึกงานที่โรงเรียนสตรีประเสริฐศิลป์ ในช่วงการฝึกงานมีระยะเวลา 3 เดือน ราบละเอียดงานก็จะเป็นงานของ IT Support แต่จะพิเศษนิดหน่อยตรงที่ว่า 
                                ...
                                ส่วนงานหลักจะเป็นดูแลอุปกรณ์คอมพิวเตอร์โรงเรียน และมีงานในส่วนของการส้รางเว็บภายในโรงเรียนด้วย</p>
                        </div>
                        <div class="flex-shrink-0"><span class="text-primary"> may 2019 </span></div>
                    </div>
                </div>
            </section>
        <!-- Bootstrap core JS-->
